...
export default class TweetButton extends React.Component {
  ...
  onTweetClick(evt) {
    ...
    window.open('https://twitter.com/intent/tweet?' +
      ...
      '&hashtags=Emojizr&related=toruta39');
  }

  render() {
    return (
      <a className="tweet-button" href="#" onClick={this.onTweetClick}>
        <svg className="twitter-icon" xmlns="http://www.w3.org/2000/svg"
          version="1.1"width="17" height="17">
          <g transform="scale(0.1,0.1) translate(-282.32053,-396.30734)">
            <path fill="#fff" id="twitter-bird"
...
TweetButton.propTypes = {text: React.PropTypes.string};
TweetButton.defaultProps = {text: ''};
